...
نسخة Next.js احترافية من استبيان LOGICCA، عربية افتراضيًا مع دعم English، وخط Cairo، وحفظ تلقائي للمسودة، وتنقّل مباشر بين الأقسام، ومراجعة قبل الإرسال، وحفظ النتائج في Neon PostgreSQL.
